...
class AlienFleet: 
    ...
    def create_fleet(self):
        ...
        for row in range(fleet_h):
            ...
            self._create_rectangle_fleet(alien_w, alien_h, fleet_w, x_offset, y_offset, row)

    def _create_rectangle_fleet(self, alien_w, alien_h, fleet_w, x_offset, y_offset, row):
